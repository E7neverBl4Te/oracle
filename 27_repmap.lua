...
local SEAM_BTN=mk("TextButton",{AutoButtonColor=false,
    BackgroundColor3=Color3.fromRGB(30,90,70),BorderSizePixel=0,
    Font=Enum.Font.GothamBold,Text="⚡ Find Seams",TextColor3=C.WHITE,TextSize=9,
    Size=UDim2.new(0,92,0,22),Position=UDim2.new(1,-368,0.5,-11),ZIndex=6},TOPBAR)
corner(5,SEAM_BTN); stroke(Color3.fromRGB(80,220,180),1,SEAM_BTN)
SEAM_BTN.MouseEnter:Connect(function() tw(SEAM_BTN,TI.fast,{BackgroundColor3=Color3.fromRGB(40,120,90)}) end)
SEAM_BTN.MouseLeave:Connect(function() tw(SEAM_BTN,TI.fast,{BackgroundColor3=Color3.fromRGB(30,90,70)}) end)

local OWN_BTN=mk("TextButton",{AutoButtonColor=false,
    BackgroundColor3=Color3.fromRGB(30,60,90),BorderSizePixel=0,
    Font=Enum.Font.GothamBold,Text="⬡ Ownership",TextColor3=C.WHITE,TextSize=9,
    Size=UDim2.new(0,84,0,22),Position=UDim2.new(1,-264,0.5,-11),ZIndex=6},TOPBAR)
corner(5,OWN_BTN); stroke(Color3.fromRGB(80,140,255),1,OWN_BTN)
OWN_BTN.MouseEnter:Connect(function() tw(OWN_BTN,TI.fast,{BackgroundColor3=Color3.fromRGB(40,80,120)}) end)
OWN_BTN.MouseLeave:Connect(function() tw(OWN_BTN,TI.fast,{BackgroundColor3=Color3.fromRGB(30,60,90)}) end)

local RATE_BTN=mk("TextButton",{AutoButtonColor=false,
    BackgroundColor3=Color3.fromRGB(60,40,90),BorderSizePixel=0,
    Font=Enum.Font.GothamBold,Text="⏱ Rep Rates",TextColor3=C.WHITE,TextSize=9,
    Size=UDim2.new(0,84,0,22),Position=UDim2.new(1,-168,0.5,-11),ZIndex=6},TOPBAR)
corner(5,RATE_BTN); stroke(Color3.fromRGB(168,120,255),1,RATE_BTN)
RATE_BTN.MouseEnter:Connect(function() tw(RATE_BTN,TI.fast,{BackgroundColor3=Color3.fromRGB(80,60,120)}) end)
RATE_BTN.MouseLeave:Connect(function() tw(RATE_BTN,TI.fast,{BackgroundColor3=Color3.fromRGB(60,40,90)}) end)

local FULL_BTN=mk("TextButton",{AutoButtonColor=false,
    BackgroundColor3=Color3.fromRGB(80,220,180),BorderSizePixel=0,
...
local BODY=mk("Frame",{BackgroundTransparency=1,BorderSizePixel=0,
    Position=UDim2.new(0,0,0,32),Size=UDim2.new(1,0,1,-32),ZIndex=3},P_REP)
